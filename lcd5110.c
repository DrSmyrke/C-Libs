...
const unsigned char PROGMEM SDcard [][7] = {
  {0x0,0x0,0x0,0x0,0x0,0x0,0x0},
  {0x0,0xFC,0x82,0x81,0x81,0xFF,0x0}
};
const unsigned char PROGMEM antena [][10] = {
  {0x2,0x4,0x7E,0x4,0x2,0x0,0x0,0x0,0x0,0x0},
  {0x2,0x4,0x7E,0x4,0x42,0x0,0x0,0x0,0x0,0x0},
  {0x2,0x4,0x7E,0x4,0x42,0x60,0x0,0x0,0x0,0x0},
  {0x2,0x4,0x7E,0x4,0x42,0x60,0x70,0x0,0x0,0x0},
  {0x2,0x4,0x7E,0x4,0x42,0x60,0x70,0x78,0x0,0x0},
  {0x2,0x4,0x7E,0x4,0x42,0x60,0x70,0x78,0x7C,0x0},
  {0x2,0x4,0x7E,0x4,0x42,0x60,0x70,0x78,0x7C,0x7E}
};
const unsigned char PROGMEM battery [][16] = {
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x7E,0x0},   // 0
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x5A,0x42,0x7E,0x0},   // 1
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x5A,0x5A,0x42,0x7E,0x0},   // 2
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x5A,0x5A,0x5A,0x42,0x7E,0x0},   // 3
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x42,0x42,0x5A,0x5A,0x5A,0x5A,0x42,0x7E,0x0},   // 4
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x42,0x5A,0x5A,0x5A,0x5A,0x5A,0x42,0x7E,0x0},   // 5
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x42,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x42,0x7E,0x0},   // 6
  {0x0,0x3C,0x66,0x42,0x42,0x42,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x42,0x7E,0x0},   // 7
  {0x0,0x3C,0x66,0x42,0x42,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x42,0x7E,0x0},   // 8
  {0x0,0x3C,0x66,0x42,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x42,0x7E,0x0}   // 9
};
...
void lcd_printBattery(unsigned char x,unsigned char y,unsigned char val)
{
  lcd_goto_xy_exact(x,y);lcd_base_addr(lcdCacheIdx);
  unsigned char i;
  for(i=0;i<15;i++){lcd_send(pgm_read_byte(&battery[val][i]),LCD_DATA);}
}
void lcd_printAntena(unsigned char x,unsigned char y,unsigned char val)
{
  lcd_goto_xy_exact(x,y);lcd_base_addr(lcdCacheIdx);
  unsigned char i;
  for(i=0;i<10;i++){lcd_send(pgm_read_byte(&antena[val][i]),LCD_DATA);}
}
void lcd_printCard(unsigned char x,unsigned char y,unsigned char val)
{
  lcd_goto_xy_exact(x,y);lcd_base_addr(lcdCacheIdx);
  unsigned char i;
  for(i=0;i<7;i++){lcd_send(pgm_read_byte(&SDcard[val][i]),LCD_DATA);}
}
